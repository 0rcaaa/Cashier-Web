...
<body>
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="space-y-4 md:space-y-6" action="../../../service/auth.php" method="POST">
                        <div>
                            ...
                            <input type="number" name="token" id="token" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0000" required="">
                        </div>
    ...
    <script>
        function verify() {
            ...
            alert("Gagal mengirim token: " + response.message);
          }
          })
          .catch(error => {
            console.error("Error:", error);
            alert("An error occurred while sending token.");
          })
        }
    </script>
</body>
