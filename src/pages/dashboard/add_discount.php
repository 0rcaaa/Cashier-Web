...
<body
  x-data="{ page: 'add_discount', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
  x-init="
            ...
            <div
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Add New Discount</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
                  ...
                  <div class="p-7">
                    ...
                    <div class="flex justify-end gap-4.5 mt-6">
                      ...
                      <button
                        ...
                        type="submit" value="addDiscount" name="action">
                        Add 
                      </button>
                    </div>
                  </div>
