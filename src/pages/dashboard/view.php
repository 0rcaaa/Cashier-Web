        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <div class="flex flex-col gap-10">
            ...
            <div
              ...
              <div class="px-4 py-6 md:px-6 xl:px-7.5 flex space-between">
                <h4 class="text-xl font-bold text-black dark:text-white">Top Products</h4>
                <p class="font-medium  hover:text-meta-5">See More</p>
              </div>
                ...
                <table class="w-full table-auto">
                  <thead>
                    <tr class="bg-gray-2 text-left dark:bg-meta-4">
                      ...
                      <th class="text-center min-w-[150px] px-4 py-4 font-medium text-black dark:text-white">
                        Name
                      </th>
                ...
                ?>
                    <tr>
                      ...
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-sm text-center font-medium text-black dark:text-white"><?= $row['product_name'] ?></p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-sm text-center font-medium text-black dark:text-white"><?= $row['brand'] ?></p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-sm text-center font-medium text-black dark:text-white"><?= $row['category_name'] ?></p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-sm text-center font-medium text-black dark:text-white"><?= "Rp " . number_format($row['product_price'], 0, ',', '.') ?></p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-sm text-center font-medium text-black dark:text-white"><?= $row['total_sold'] ?></p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-sm text-center font-medium text-meta-3"><?= "Rp " . number_format($row['profit'], 0, ',', '.') ?></p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
