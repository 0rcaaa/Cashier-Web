...
<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
  <div
    ...
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <!-- Hamburger Toggle BTN -->
      <a class="block flex-shrink-0 lg:hidden" href="<?= base_url() ?>/serc/pages/dashboard/index.php">
        <img src="<?= base_url() ?>/src/assets/images/logo/logo_white.png" style="width: 10%;" alt="Logo" />
      </a>
    </div>
      ...
      <div
        ...
        <a
          ...
          <span class="hidden text-right lg:block">
            <span class="block text-sm font-medium text-black dark:text-white"><?= $_SESSION['name'] ?></span>
            <span class="block text-xs font-medium"><?= $_SESSION['role'] ?></span>
          </span>

          <span class="h-12 w-12 rounded-full">
            <img class="rounded-full" src="<?= base_url() ?>/src/assets/images/logo/profile.jpg" alt="User" />
          </span>
        ...
        <div
          ...
          <button
            ...
            onclick="window.location.href='../auth/logout.php'"> <svg
              class="fill-current"
              width="22"
              height="22"
              viewBox="0 0 22 22"
